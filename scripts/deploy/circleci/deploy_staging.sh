...
# your fork is located at https://github.com/geinarsdottir/open-sdg-site-starter, then
# you should put "geinarsdottir" here. Changing this is required.
GH_ORG_STAGING="geinarsdottir"
# These variables only control the name/email on the automated Git commits.
# Changing this is optional.
GH_NAME="CircleCI"
GH_EMAIL="gro.einarsdottir@hagstofa.is"
###################################
